...
"}")
        ...
        self.formLayout_2.setWidget(8, QFormLayout.FieldRole, self.pushButton_2)
        ...
        self.formLayout_2.setItem(6, QFormLayout.LabelRole, self.horizontalSpacer)
...
"}")
        ...
        self.formLayout_2.setWidget(7, QFormLayout.FieldRole, self.pushButton_3)
